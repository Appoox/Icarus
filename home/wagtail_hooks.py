...
def analytics_view(request):
    ...
    has_en = Article.objects.live().exclude(body_en='').exclude(body_en__isnull=True).count()
    has_hi = Article.objects.live().exclude(body_hi='').exclude(body_hi__isnull=True).count()
    has_ta = Article.objects.live().exclude(body_ta='').exclude(body_ta__isnull=True).count()
